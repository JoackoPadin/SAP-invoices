		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#ItReadyinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ItReadyinvoices-display": {
								"semanticObject": "ItReadyinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ItReady.invoices",
									"url": sap.ui.require.toUrl("ItReady/invoices")
								}
							}
						}
					}
